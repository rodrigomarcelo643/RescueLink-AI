...
import PublicHappenings from '@/pages/public/PublicHappenings'
    ...
    <BrowserRouter>
      ...
      <ErrorBoundary>
        <Routes>
          ...
          <Route path="/happenings" element={<Navigate to="/near-incident-live-monitoring" replace />} />
          <Route path="/public-happenings" element={<Navigate to="/near-incident-live-monitoring" replace />} />
